...
CREATE TABLE `ativos` (
  ...
  `nome_aluno` varchar(100) DEFAULT 'Matheus Yamamoto Dias',
  PRIMARY KEY (`id`)
...
INSERT INTO `ativos` VALUES (4,'Vale3','Ação',10.00,40.00,'2023-02-10','Matheus Yamamoto Dias');
/*!40000 ALTER TABLE `ativos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'investimentos'
--
...
-- Dump completed on 2026-04-07 21:15:57
